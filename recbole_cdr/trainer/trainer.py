...
import numpy as np
from recbole_cdr.trainer.recbole_trainer import Trainer
    ...
    def fit(self, train_data, valid_data=None, verbose=True, saved=True, show_progress=False, callback_fn=None):
        ...
        for phase in range(len(self.train_modes)):
            ...
            if self.split_valid_flag and valid_data is not None:
                ...
                if source_valid_data.overlap_users is None:
                    source_valid_data.overlap_users = train_data.overlap_users
                if target_valid_data.overlap_users is None:
                    target_valid_data.overlap_users = train_data.overlap_users
