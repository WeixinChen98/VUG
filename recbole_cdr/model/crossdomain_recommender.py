...
class CrossDomainRecommender(AbstractRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        self.num_overlap_user = dataset.num_overlap_user
        self.num_source_only_user = dataset.num_source_only_user
        self.num_target_only_user = dataset.num_target_only_user
